...
(0, prompt_sync_1.default)()("Pressione ENTER para descobrir quem está atacando a cidade");
class Carta {
    constructor(nome, forca, inteligencia, defesa, vida, agilidade, valorAssist, adicionaAssist) {
        this.nome = nome;
        this.forca = forca;
        ...
        this.valorAssist = valorAssist;
        this.adicionaAssist = adicionaAssist;
    }
}
...
class Heroi extends Carta {
    ...
    usarComoAssistente(personagemPrincipal) {
...
const sorteioHeroiPrincipal = () => {
    const cartaPrincipalJogador = herois[Math.floor(Math.random() * herois.length)];
    return cartaPrincipalJogador;
};
const sorteioAssistente = (cartaPrincipalJogador) => {
    let cartaAssistenteJogador = herois[Math.floor(Math.random() * herois.length)];
...
const sorteioVilao = () => {
    const cartaPrincipalComputador = viloes[Math.floor(Math.random() * viloes.length)];
    return cartaPrincipalComputador;
};
const sorteioAssistenteVilao = (cartaPrincipalComputador) => {
    let cartaAssistenteComputador = viloes[Math.floor(Math.random() * viloes.length)];
...
console.log("\n");
(0, prompt_sync_1.default)()("(pressione o botão “enter” para sortear o seu herói e defender a cidade)");
console.log("\n");
cartaPrincipalJogador.usarComoPrincipal();
console.log("\n");
(0, prompt_sync_1.default)()("Espere... o que está acontecendo?");
console.log("\n");
cartaAssistenteComputador.usarComoAssistente(cartaPrincipalComputador);
console.log("\n");
(0, prompt_sync_1.default)()("Mas veja...");
console.log("\n");
cartaAssistenteJogador.usarComoAssistente(cartaPrincipalJogador);
// mostrar o que esta quem ganhou em cada categoria
console.log("\n");
(0, prompt_sync_1.default)()("Prontos para iniciar a batalha?");
console.log("\n");
...
const batalha = () => {
    ...
    console.log("\n");
    (0, prompt_sync_1.default)()("E quando a fumça baixa, finalmente podemos ver...");
    console.log("\n");
